            ...
            <div>
                ...
                <div className='flex items-center justify-center max-w-7xl mx-auto'>
                    <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10'>
                        ...
                        {
                            loading ? <Button className='w-full my-4'><Loader2 className='mr-2 h-2 w-4 animate-spin'/>Please wait..</Button> : <Button type='submit' className='w-full my-4 h-11'>Login</Button>
                        }
